...
class FineTuneYoloNode(Node):
    ...
    def __init__(self):
        ...
        self.model = YOLOWorld('/weights/yolov8s-world.pt')
        self.get_logger().info("Model loaded successfully")
        self.model.set_classes(["bouteille", "cles", "smartphone", "canette", "alien_plushie", "tasse", 
                                "balle", "sac", "chaussure", "livre", "ordinateur", "bouteille_eau", "stylo", 
                                "lunettes", "casque", "télécommande", "coussin", "lampe", "tablette", 
                                "souris", "clavier", "téléphone", "montre"])
